                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="p-5">
                            ...
                            <form  method="POST" action="dbregistercode.php" id="firstForm" enctype="multipart/form-data"   >
                        ...
                        <div class="p-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="text-right">
                                    ...
                                    <input type="submit" id="submitLastForm" name="dbreg1" class="btn btn-primary btn-user" value="Submit">
                                </div>
                            </form>
...
function validateLicense() {
    ...
    if (pincode.length !== 6) {
        pincodeError.textContent = "Please enter a valid Indian pincode with six digits.";
        return false;
    }
