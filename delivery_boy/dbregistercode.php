...
if(isset($_POST['dbreg1'])) 
{
    ...
    $insert_query1 = "INSERT INTO tbl_deliveryboy (`user_id`, `db_phone`, `db_firstname`, `db_middlename`, `db_lastname`,  `db_aadhar`, `db_licence`) 
                    VALUES ('$user_id', '$phone', '$first_name', '$middle_name', '$last_name', '$aadhar_card_file', '$license_file')";
